...
<head>
    ...
    <title>TK Bina Pertiwi - Monitoring Perkembangan Anak</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-16">
                ...
                <div class="bg-slate-50 p-8 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50">
                    ...
                    <div class="mt-8 p-4 bg-blue-50 rounded-2xl border border-blue-100 flex items-start gap-3">
                        ...
                        <p class="text-sm text-blue-800">Profil ini dapat diperbarui oleh <strong>Admin</strong> melalui menu <em>Profil TK</em> di dashboard.</p>
                    </div>
                </div>
            </div>
        </div>
